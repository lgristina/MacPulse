...
extension DeveloperToolsSupport.ImageResource {
    ...
    static let macPulse = DeveloperToolsSupport.ImageResource(name: "MacPulse", bundle: resourceBundle)
...
extension AppKit.NSImage {
    ...
    /// The "MacPulse" asset catalog image.
    static var macPulse: AppKit.NSImage {
#if !targetEnvironment(macCatalyst)
        .init(resource: .macPulse)
#else
        .init()
#endif
    }
...
extension UIKit.UIImage {
    ...
    /// The "MacPulse" asset catalog image.
    static var macPulse: UIKit.UIImage {
#if !os(watchOS)
        .init(resource: .macPulse)
#else
        .init()
